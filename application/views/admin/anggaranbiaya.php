...
<script>
  angular.module('app', ['data.service', 'helper.service'])
    .controller('anggaranBiayaController', function ($scope, $http, AnggaranBiayaService, helperServices) {
      $scope.datas = [];
      $scope.model = {};
      $scope.daftarKegiatan = false;
      $scope.listKegiatan = {};
      AnggaranBiayaService.get()
