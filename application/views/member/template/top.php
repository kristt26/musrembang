...
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand-sm navbar-dark navbar-white ">
    <div class="container">
      <a href="<?=base_url();?>assets/index3.html" class="navbar-brand">
        <img src="<?=base_url();?>assets/img/logo.png" alt="AdminLTE Logo" class="brand-image"
             style="opacity: .8">
        <span class="brand-text font-weight-dark">Kelurahan Hamadi</span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown dropdown-hover">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow navbar-red">
